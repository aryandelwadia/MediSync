...
export default function AdminDashboard() {
  ...
  const fetchTotalDoctors = async () => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/admin/total-doctors`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchTotalPatients = async () => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/admin/total-patients`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchDoctorOverview = async () => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/admin/doctor-overview`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const renderAddDoctor = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await fetch(`${process.env.REACT_APP_API_URL}/api/admin/add-doctor`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
